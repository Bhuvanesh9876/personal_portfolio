      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center">
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="hidden md:block px-4 py-2 lg:px-6 lg:py-2 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full font-medium hover:shadow-lg transition-shadow text-sm lg:text-base"
            ...
            >
              <div className="py-4 space-y-2">
                ...
                <motion.button
                  whileTap={{ scale: 0.95 }}
                  onClick={() => scrollToSection('contact')}
                  className="w-full text-left px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 text-white rounded-lg mx-4 my-2 font-medium"
                >
                  Get In Touch
                </motion.button>
              </div>
